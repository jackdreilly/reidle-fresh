with MYSUBMISSIONS as (
    ...
    where NAME = $name and CHALLENGE_ID is null
),
...
select
    ...
    COALESCE(BY_SCORE_JSON.BY_SCORE, '[]') as "rank",
    COALESCE(BY_PENALTY_JSON.BY_PENALTY, '[]') as "penalty",
    COALESCE(BY_TIME_JSON.BY_TIME, '[]') as "time",
    COALESCE(BY_WEEK_JSON.BY_WEEK, '[]') as "week"
from
    BY_SCORE_JSON,
    BY_PENALTY_JSON,
    BY_TIME_JSON,
